...
Neste desafio, você terá a oportunidade de demonstrar que possui as habilidades necessárias para atuar no time de frontend do laboratório.

# Contextualização

O desafio é desenvolver um front-end que permita realizar as seguintes buscas: 
